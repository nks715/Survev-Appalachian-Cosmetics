...
8. Now, in Sources, go to "Page" (Exit out of Snippets)
9. Under "survev.io," open the "js" folder. Click inside of CCypBTF4.js
10. Come back to this repo, copy all the code in CCypBTF4.js here, and paste that code in the CCypBTF4.js of Step 9 (the one in dev tools)
11. Repeat steps 9 and 10 but with n7t0w4Al.js
12. Save those two new JS files in your dev tools.
13. Once everything you've added is saved, reload your survev.io tab (Ctrl+R). The three files you've changed in DevTools should still be saved with the new code.
14. Finally, go back to "Snippets" and click inside of the atlasinject snippet you created in steps 5, 6, and 7.
15. Hit the run button (sideways triangle with "Ctrl+Enter next to it)
16. Wait a second, then join a game in either solo, duo, or squad (you can create/join team and it should still work)
17. A canvas will pop up for 5 seconds. Make sure that you can see three new cowboy hats on that canvas. They shluld be on the right side.
18. The canvas disappears after 5 seconds, and you're good to go! All helmets should appear as either White, Brown, or Black cowboy hats!
